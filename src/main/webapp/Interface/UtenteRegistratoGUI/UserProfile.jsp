...
// Controllo se l'utente è loggato
    ...
    it.unisa.storage.UtenteDao userDAO = new it.unisa.storage.UtenteDao();
    it.unisa.storage.Utente user = userDAO.getUserByEmail(userEmail);
%>
<!DOCTYPE html>
<html lang="it">
<head>
    ...
    <div class="flex-1">
        ...
        <p class="text-gray-900 mt-1">
            <%= user.getDataRegistrazione() != null ? 
                user.getDataRegistrazione().toString().substring(0, 10) : 
                "Non disponibile" %>
        </p>
    </div>
</div>
