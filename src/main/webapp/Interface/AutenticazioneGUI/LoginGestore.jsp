...
<head>
    <meta charset="UTF-8">
    <title>Accesso Gestore - FakeNews Checker</title>
    ...
    <div class="min-h-screen bg-white flex items-center justify-center p-4">
        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 relative">
                ...
                <div class="absolute inset-0 bg-gradient-to-br from-purple-50/30 to-blue-50/30 rounded-2xl -z-10"></div>
                ...
                <div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
                    ...
                    <p class="text-sm text-red-600"><%= errore %></p>
                </div>
                <% } %>
                ...
                <form action="<%= request.getContextPath() %>/login" method="post" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" placeholder="gestore@fakenews.com"
                               class="mt-1.5 w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500" 
                               required>
                    </div>
