        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 relative">
                ...
                <div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
                    ...
                    <p class="text-sm text-red-600">Password o e-mail non validi</p>
                </div>
                ...
                <form action="<%= request.getContextPath() %>/login" method="post" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" placeholder="esempio@email.com" 
                               class="mt-1.5 w-full px-3 py-2 border border-red-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500" required>
                    </div>
